...
-- 결제
ALTER TABLE TABLE2
	ADD CONSTRAINT PK_TABLE2 -- 결제 기본키
	PRIMARY KEY (
		CART_NO -- 결제번호
	);
...
-- 방
ALTER TABLE ROOM
	ADD CONSTRAINT FK_USER_TO_ROOM -- 사용자 -> 방
	FOREIGN KEY (
		USER_ID -- 아이디
	)
	REFERENCES USER ( -- 사용자
...
-- 렌트카
ALTER TABLE CAR
	ADD CONSTRAINT FK_USER_TO_CAR -- 사용자 -> 렌트카
	FOREIGN KEY (
		USER_ID -- 아이디
	)
	REFERENCES USER ( -- 사용자
...
-- 관광명소
ALTER TABLE TOUR
	ADD CONSTRAINT FK_USER_TO_TOUR -- 사용자 -> 관광명소
	FOREIGN KEY (
		USER_ID -- 아이디
	)
	REFERENCES USER ( -- 사용자
...
-- 결제
ALTER TABLE TABLE2
	ADD CONSTRAINT FK_PACK_TO_TABLE2 -- 패키지 -> 결제
	FOREIGN KEY (
		PACK_NUM -- 패키지번호
	)
	REFERENCES PACK ( -- 패키지
...
-- 결제
ALTER TABLE TABLE2
	ADD CONSTRAINT FK_USER_TO_TABLE2 -- 사용자 -> 결제
	FOREIGN KEY (
		USER_ID -- 아이디
	)
	REFERENCES USER ( -- 사용자
